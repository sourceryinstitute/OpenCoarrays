...
# the path to the quoted text in the CMAKE_Fortran_FLAGS argument below. For example, use
...
# Edit the CMAKE_TOOLCHAIN_FILE to reflect the appropriate toolchain file for you operating system.
...
cmake \
  ...
  -D HIGH_RESOLUTION_TIMER:BOOL=FALSE \
  -D CMAKE_TOOLCHAIN_FILE:FILEPATH=${SOURCE_PATH}/../buildScripts/os-x-toolchain.cmake \
$EXTRA_ARGS \
$SOURCE_PATH
