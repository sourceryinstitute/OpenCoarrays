...
source "${OPENCOARRAYS_SRC_DIR:-}/install_prerequisites/build-functions/set_or_list_versions.sh"
set_or_list_versions
version_to_build="${arg_I:-${default_version}}"
info "Building ${arg_p} ${version_to_build}"

source "${OPENCOARRAYS_SRC_DIR:-}/install_prerequisites/build-functions/set_or_print_downloader.sh"
set_or_print_downloader
info "Download method: ${fetch}"

source "${OPENCOARRAYS_SRC_DIR:-}/install_prerequisites/build-functions/set_package_url.sh"
set_package_url
info "Package URL: ${package_url}"

source "${OPENCOARRAYS_SRC_DIR:-}/install_prerequisites/build-functions/download_if_necessary.sh"
download_if_necessary
info "Package download location: ${download_path}"

source "${OPENCOARRAYS_SRC_DIR:-}/install_prerequisites/build-functions/unpack_if_necessary.sh"
unpack_if_necessary
info "Unpacked source location: ${download_path}/${url_tail}"
