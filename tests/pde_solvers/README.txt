...
heat equation solver inthat the Burgers solver adds one additional term
...
http://tau.uoregon.edu.  Because of a bug a memory leak in the Intel compiler,
...
parallel on over 13,000 cores and 87% parallel efficiency on 16,384 cores
in weak scaling when compiled with the Cray Compiler Environment.  For new
scalabiliby studies, it is important to run problems of sufficient size.
